<?php
function render_system_card($system, $url, $access_text = 'Access System') {
    global $system_logos;
    ...
    // Get the CSS_SYSTEM_CARD constant
    $css_card_class = defined('CSS_SYSTEM_CARD') ? CSS_SYSTEM_CARD : 'system-card glass-card card-hover';
    
    return <<<HTML
    <div class="{$system_class} {$css_card_class} flex flex-col h-full">
            ...
            <div class="p-6 flex flex-col items-center h-full">
                ...
                <div class="w-24 h-24 mb-4 flex items-center justify-center">
                    <img src="{$logo_path}" 
                         ...
                         onerror="this.src='assets/icons/default-icon.jpg'" />
                </div>
